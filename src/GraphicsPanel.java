...
public class GraphicsPanel extends JPanel implements KeyListener{
	...
	private Item item;
	private ArrayList<Item> asteroids;
	private int counter;
	...
	public GraphicsPanel(){
		...
		item = new Item(1000, 200, "images/objects/box.png", 4);  
	...
	public void clock(){
		...
		counter++;
		if(counter%100==0) {
		asteroids.add(new Item(1400, (int)(Math.random()*400), "images/objects/box.png", 4));
		}
		
		for(int i = 0; i < asteroids.size(); i++) {
			asteroids.get(i).moveLeft();
